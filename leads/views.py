...
class LeadCreateView(OrganisorAndLoginRequiredMixin, generic.CreateView):
    ...
    def form_valid(self, form):
        ...
        lead.save()
        send_mail(
            subject="A leads has been created",
            message="Go to the site to see the new leads",
            from_email="test@test.com",
            recipient_list=["test2@test.com"]
        )
        messages.success(self.request, "You have successfully created a leads")
...
class LeadUpdateView(OrganisorAndLoginRequiredMixin, generic.UpdateView):
    ...
    def form_valid(self, form):
        form.save()
        messages.info(self.request, "You have successfully updated this leads")
...
class LeadCategoryUpdateView(LoginRequiredMixin, generic.UpdateView):
    ...
    def form_valid(self, form):
        ...
        if form.cleaned_data["category"] == converted_category:
            # update the date at which this leads was converted
            if lead_before_update.category != converted_category:
                # this leads has now been converted
...
class FollowUpCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context.update({
            "leads": Lead.objects.get(pk=self.kwargs["pk"])
        })
        return context
